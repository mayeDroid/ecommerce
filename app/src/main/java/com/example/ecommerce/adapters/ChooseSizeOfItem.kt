...
class ChooseSizeOfItem : RecyclerView.Adapter<ChooseSizeOfItem.ChooseSizeOfItemViewHolder>() {
    ...
    inner class ChooseSizeOfItemViewHolder(private val binding: RvChooseSizeOfItemBinding) :
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ChooseSizeOfItem.ChooseSizeOfItemViewHolder {
        return ChooseSizeOfItemViewHolder(
            RvChooseSizeOfItemBinding.inflate(
                LayoutInflater.from(
                    parent.context
                )
            )
    ...
    override fun onBindViewHolder(
        holder: ChooseSizeOfItem.ChooseSizeOfItemViewHolder,
        position: Int
    ) {
